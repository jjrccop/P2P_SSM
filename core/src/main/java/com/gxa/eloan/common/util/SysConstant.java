package com.gxa.eloan.common.util;
...
public class SysConstant {
	 ...
	 * 发送手机验证码的时间间隔
	 */
	public static final long SEND_VERIFYCODE_INTERVAL  =  60 ; //秒
	/**
	 * 手机验证码的有效时间
	 */
	public static final long VERIFYCODE_VALID_TIME  =  300 ; //秒
	/**
	 * 激活邮件的有效期
	 */
	public static final long EMAIL_VALID_DAY  =  3 ; //天
	/**
	 * 用户信用借款的对用风控的最低分数
	 */
	...
	// ---------------------标的类型--------------------------
	public final static Byte BIDREQUEST_TYPE_NORMAL = 0; // 普通信用标
