		...
		<script type="text/javascript">
			$(function(){
				...
				$("#pagination").twbsPagination({
					...
					visiblePages:5,
					startPage:${iplogQueryObject.currentPage},
				...
				<div class="col-sm-9">
					<form action="/ipLog.do" name="searchForm" id="searchForm" class="form-inline" method="post">
						...
						<div class="form-group">
							<label>时间范围</label>
							<input type="text" class="form-control beginDate" name="beginDate" value='${(iplogQueryObject.beginDate?string("yyyy-MM-dd"))!""}'/>
						</div>
						<div class="form-group">
							<label></label>
							<input type="text" class="form-control endDate" name="endDate" value='${(iplogQueryObject.endDate?string("yyyy-MM-dd"))!""}'/>
						</div>
						<div class="form-group">
						    <label>状态</label>
